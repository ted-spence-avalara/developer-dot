...
Each AvaTax account has one (and only one!) license key.  This license key is generated by an account administrator on the <a href="https://admin.avalara.com">AvaTax Website</a>.  Here's how to generate a license key:

<ul class="normal">
    <li>Log on to the <b><a href="https://admin.avalara.com/">AvaTax Website</a></b></li>
